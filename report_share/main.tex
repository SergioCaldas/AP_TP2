...
\title{LU Factorization with Partial Pivoting}


% author names and affiliations
% use a multiple column layout for up to three different
% affiliations
\author{\IEEEauthorblockN{Sérgio Caldas\IEEEauthorrefmark{1} and Filipe Oliveira\IEEEauthorrefmark{2}}
\IEEEauthorblockA{University of Minho\\ Computer Science Department\\
Email: \IEEEauthorrefmark{1}a57779@alunos.uminho.pt, \IEEEauthorrefmark{2}a57816@alunos.uminho.pt}
}
...
\begin{IEEEkeywords} LU Factorization\footnote{Lecture 12 LU Decomposition} - Gaussian Eliminations - Linear Systems - Pivoting \end{IEEEkeywords}
